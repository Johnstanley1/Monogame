...
{
    public class CannonBallHitPeirce : GameComponent
    {
        ...
        public CannonBallHitPeirce(Game game, CannonBall_3 cannonBall, List<EnemyShip3> enemyShips3, SoundEffect bang, CannonExplosion cannonExplosion) : base(game)
        {
