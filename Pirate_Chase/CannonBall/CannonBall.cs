...
namespace Pirate_Chase
{
    ...
    public class CannonBall : DrawableGameComponent
    {
		...
		public CannonBall(Game game, SpriteBatch sb, Texture2D tex, Vector2 position, Vector2 speed, float scale) : base(game)
		{
			this.sb = sb;
